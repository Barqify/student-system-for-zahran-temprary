import { SettingType } from "./interfaces/setting/index";
export const setting: SettingType = {
  ...
  dashboard: "https://dashboard.zahranacademy.com",
  paymentMethods: {
    kashir: {
      isWork: true,
  ...
  coursesHeaderData: {
    3: {
      revision: "مراجعات شرح وحل الصف الثالث الثانوي",
      season: "شرح وحل الصف الثالث الثانوي",
    },
    2: {
      revision: "مراجعات حل الصف الثاني الثانوي",
      season: "شرح و حل الصف الثاني الثانوي",
    },
    1: {
      revision: "مراجعات حل الصف الاول الثانوي",
      season: "حل الصف الاول الثانوي",
    },
  },
  questionSupport: {
    isWork: true,
